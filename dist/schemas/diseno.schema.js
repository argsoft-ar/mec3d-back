...
const specSchema = zod_1.z.object({
    title: zod_1.z.string().min(1, 'El título de la especificación es requerido'),
    value: zod_1.z.string().min(1, 'El valor de la especificación es requerido'),
});
const productBodySchema = zod_1.z.object({
    ...
    especificaciones: zod_1.z.array(specSchema).optional(),
});
