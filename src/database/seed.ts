...
(async () => {
  ...
  try {
    ...
    // ── Categories ─────────────────────────────────────────────────────────────
    const categories = [
      { nombre: 'Mecánica',    descripcion: 'Piezas y componentes mecánicos funcionales' },
      { nombre: 'Decoración',  descripcion: 'Objetos decorativos y artísticos para el hogar' },
      { nombre: 'Electrónica', descripcion: 'Carcasas, soportes y accesorios para electrónica' },
    ];
    ...
    const disenos = [
      ...
      },
      {
        ...
        especificaciones: [
          ...
          { label: 'Ventilación', value: 'Ranuras laterales + slot para cooler 30mm' },
        ],
      },
      {
